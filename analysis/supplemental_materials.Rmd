...
Figure \ref{fig:cohorts}) shows that the vast majority of surveyed individuals were less than 6 years old. Due to the sparse of data for old individuals and the fact that Mývatn's charr reach sexual maturity at around age 4, we group all individuals age 4 and older into a single "adult" age class. The number of surveyed individuals in each cohort increased generally from age 1 to 2 and occasionally increased from age 2 to 3. In a population closed to immigration, the number of individuals in the cohort must decrease with cohort age, which indicates systematic detection bias against age 1 and (to a lesser extent) age 2 individuals.
